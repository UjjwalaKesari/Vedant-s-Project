...
function setup(){
    ...
    playButton = createSprite(400, 550, 1, 1);
...
function draw(){
    ...
    if(gameState === "start"){
      ...
      fill("purple");
      textSize(40);
      text("Press Left Arrow To Pick Garbage", 90 , 300);
      pop();
    ...
    text("Water Bottles Collected:" + waterScore, 300,20)
    fill("red");
    text("Not Collected:" + floor(missed/12), 300,50)
    pop()
  }
  ...
  if(gameState === "end"){
    ...
    //display score 
      ...
      fill("red");
      textSize(40);
      text("You Missed To Pick More Than 5 Trash!!", 50,100)
      stroke("blue");
      fill("blue");
      textSize(30);
      text("Game Over!! Try again!!", 250, 300);
      totalScore = canScore + chipsScore + waterScore;
      text("Your score: " + totalScore, 250, 450)
      pop();
